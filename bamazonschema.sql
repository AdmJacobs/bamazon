...
VALUES ("Samsung LED TV", "Electronics",750.00, 6, 13000),
("Apple Keyboard", "Electronics", 75.00, 3, 12500),
("Samsung Surround Sound System", "Electronics", 250, 7, 14000),
("Windows Surface Laptop", "Electronics", 550, 3, 12000),
("XBox One", "Electronics", 150, 5, 12100);

INSERT INTO products (product_name, department_name, price, stock_quantity, product_sales )
VALUES ("Timberland Boots", "Clothing and Shoes",120.00, 3, 4400),
("Rising Sun Running Jacket", "Clothing and Shoes", 275.00, 6, 4500),
("Brooks Trail Running Shoes", "Clothing and Shoes", 175.00, 2, 4800),
("Columbia Rain Coat", "Clothing and Shoes", 375.00, 2, 5100);

INSERT INTO products (product_name, department_name, price, stock_quantity, product_sales )
VALUES ("Vitamix Power Blender", "Home and Garden and Kitchen", 350.00, 3, 8400),
...
INSERT INTO products (product_name, department_name, price, stock_quantity, product_sales )
VALUES ("Nike 15lb Kettlebell", "Beauty and Health", 50.00, 6, 9000),
